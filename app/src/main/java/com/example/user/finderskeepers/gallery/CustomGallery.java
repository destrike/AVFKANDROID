package com.example.user.finderskeepers.gallery;
...
import com.example.user.finderskeepers.gallery.AlbumInsideFragment;
import com.example.user.finderskeepers.gallery.AlbumListFragment;
